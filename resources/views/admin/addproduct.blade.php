  ...
  <div class="content-wrapper">
    ...
    <div class="alert alert-danger">
      ...
      @endif
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="{{route('store_product')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input typWatchese="text" id="price" name="product_price" class="form-control" id="exampleInputPassword1" placeholder="Enter Price">
                  </div>
                  <div class="form-group">
