...
<script>
  ...
  paypal.Buttons({
      ...
      createSubscription: function(data, actions) {
        var dynamicPlanPrice = 199; 
        return actions.subscription.create({
          /* Creates the subscription */
          plan_id: 'P-6JN174000L2381109MVWWFAA',
          quantity: 1, // The quantity of the product for a subscription
          custom_id: 'dynamic_subscription_' + dynamicPlanPrice,
  ...
  }).render('#paypal-button-container-P-6JN174000L2381109MVWWFAA'); // Renders the PayPal button
</script>
</body>
</html>
